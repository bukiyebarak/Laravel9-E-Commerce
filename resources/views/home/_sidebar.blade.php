            ...
            <div class="modal-body">
                <div class="sidebar-about-content">
                    ...
                    <div class="about-the-store">
                        <p>@lang("One of the most popular on the web is shopping. Lorem ipsum dolor sit amet, consectetur adipiscing elit.")</p>
                ...
                <div class="sidebar-new-in-store">
                    ...
                    <p>@lang("Bu fırsat kaçmaz yeni ürünler yeni indirimler")...</p>
                    <a href="{{route('discount_products')}}" class="shop-now-btn">@lang("Shop Now")</a>
                </div>
            </div>
        </div>
    </div>
