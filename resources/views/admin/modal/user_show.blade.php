<div class="modal fade text-left" id="exampleLargeModal{{$rs->user->id}}" tabindex="-1" role="dialog"
     aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang("User Show")</h5>
                        ...
                        <form action="{{route('admin_user_role_add',['id'=>$dataUser->id])}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" style="margin-top: 20px; text-align: center">
                                    <button type="submit" class="btn btn-danger "><i class="bx bxs-plus-circle"></i>@lang("Add Role")
                                    </button>
                                </div>
                            </div>
                        </form>
