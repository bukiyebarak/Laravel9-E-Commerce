    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h4 style="color: #7587ff;">Your Product(s)</h4>
                <div class="my-4 border-top"></div>
                @foreach($datalistmodal as $rs)
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-2 imageProduct" style="text-align: center">
                                @if($rs->product->image!=null)
                                    <img src="{{asset('images/'.$rs->product->image)}}" class="imageProduct" height="120" width="120" alt=""
                            ...
                            <div class="col-sm-12 col-md-3 productStatus">
                                <label>Status</label>
                                <select class="form-select form-select mb-3" aria-label=".form-select-lg example"
                                        name="status">
